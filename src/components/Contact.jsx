    ...
    return (
        <Container className="pt-3">
            ...
            <Row className="mt-5 text-center">
                <Col>
                    <div className="contact-card bg-dark text-white rounded-circle d-inline-flex flex-column flex-nowrap align-items-center pt-4 border border-3 border-success" >
                ...
                <Col>
                    <div className="bg-dark text-white contact-card rounded-circle d-inline-flex flex-column flex-nowrap align-items-center pt-3 border border-3 border-success" >
